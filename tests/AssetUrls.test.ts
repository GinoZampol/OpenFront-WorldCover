...
describe("AssetUrls", () => {
  ...
  test("prefixes a path-only base for static hosts mounted below root", () => {
    expect(buildAssetUrl("maps/worldcover/map.bin", {}, "/my-game/")).toBe(
      "/my-game/maps/worldcover/map.bin",
    );
  });
