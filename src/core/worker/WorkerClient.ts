...
export class WorkerClient {
  ...
  async initialize(): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      ...
      // Very large custom maps can spend more than a minute allocating their
      // client-side simulation in slower browsers. Keep the guard, but avoid
      // reporting a false connection failure while initialization is active.
      setTimeout(() => {
