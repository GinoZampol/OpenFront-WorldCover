...
export enum GameMapType {
  ...
  WorldCover = "WorldCover Economy", // map-generator/assets/maps/worldcover/info.json
...
export const maps: readonly MapInfo[] = [
  ...
  {
    id: "WorldCover",
    type: GameMapType.WorldCover,
    translationKey: "map.worldcover",
    categories: ["new", "featured", "world"],
    multiplayerFrequency: 1,
  },
  {
    id: "WorldInverted",
