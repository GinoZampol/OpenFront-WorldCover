...
export const LAND_VALUE_STATS_KEY = "settings.landValueStats";
export const LAND_VALUE_STATS_EXPANDED_KEY = "settings.landValueStatsExpanded";
...
export class UserSettings {
  ...
  landValueStats() {
    return this.getBool(LAND_VALUE_STATS_KEY, false);
  }

  landValueStatsExpanded() {
    return this.getBool(LAND_VALUE_STATS_EXPANDED_KEY, true);
  }
  ...
  toggleLandValueStats() {
    this.setBool(LAND_VALUE_STATS_KEY, !this.landValueStats());
  }

  toggleLandValueStatsExpanded() {
    this.setBool(LAND_VALUE_STATS_EXPANDED_KEY, !this.landValueStatsExpanded());
  }
