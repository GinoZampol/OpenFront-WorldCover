 ...
 *
 * EXCEPTION: tilesOwned / landValue / gold / troops are deliberately NOT diffed here.
...
export function diffPlayerUpdate(
  ...
  // changes (tilesOwned/landValue/gold/troops travel separately) — return without
  ...
  // tilesOwned / landValue / gold / troops intentionally absent — see EXCEPTION above.
...
export function applyStateUpdate(target: PlayerState, pu: PlayerUpdate): void {
  ...
  if (pu.landValue !== undefined) target.landValue = pu.landValue;
