...
export class FetchGameMapLoader implements GameMapLoader {
  ...
  public getMapData(map: GameMapType): MapData {
    ...
    const mapData = {
      ...
      map8kBin: () => this.loadBinaryFromUrl(this.url(fileName, "map8k.bin")),
      map8k4xBin: () =>
        this.loadBinaryFromUrl(this.url(fileName, "map8k4x.bin")),
      map10kBin: () => this.loadBinaryFromUrl(this.url(fileName, "map10k.bin")),
      map10k4xBin: () =>
        this.loadBinaryFromUrl(this.url(fileName, "map10k4x.bin")),
