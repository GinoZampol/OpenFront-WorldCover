...
import { GameMapType, GameMode, GameType, Gold } from "../../../core/game/Game";
      ...
      >
        ...
        >
          <span class="text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]"
            >${this.formatTroops(this._troops)}</span
          >
          <span class="text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]"
            >${this.formatTroops(this._maxTroops)}</span
          >
        </div>
        <div
        ...
        >
          ...
          <span
            ...
            >+${this.formatTroops(this.troopRate)}/s</span
          >
        </div>
      </div>
    `;
