...
import { Cell, GameMapType, PlayerType } from "../../core/game/Game";
import { UserSettings } from "../../core/game/UserSettings";
import { Controller } from "../Controller";
import { AlternateViewEvent } from "../InputHandler";
import { MapRenderer } from "../render/gl";
import type { AttackTroopLabel } from "../render/gl/passes/WorldTextPass";
import { renderTroops, renderWorldCoverTroops } from "../Utils";
...
export class AttackingTroopsController implements Controller {
  ...
  private readonly formatTroops: (troops: number) => string;
  ...
  constructor(
    ...
    this.formatTroops =
      game.config().gameConfig().gameMap === GameMapType.WorldCover
  ...
  private ensureEntry(attackID: string, troops: number, isIncoming: boolean) {
    const text = this.formatTroops(troops);
